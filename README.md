...
I am a passionate Full-Stack Developer with a strong focus on backend architecture, database optimization, and building efficient, scalable web applications. I love solving complex logical puzzles, designing clean APIs, and continuously exploring new technologies to improve system performance. 

- 🛠️ Currently deep-diving into backend ecosystems and secure coding practices.
- ⚡ Fun fact: I enjoy understanding how things work under the hood—whether it's an API request lifecycle or network security.
